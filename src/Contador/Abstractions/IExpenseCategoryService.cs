...
namespace Contador.Abstractions
{
	...
	public interface IExpenseCategoryService
	{
		...
		Task<Result<ExpenseCategory>> AddExpenseCategoryAsync(ExpenseCategory category);
		...
		Task<Result<ExpenseCategory>> UpdateExpenseCategoryAsync(int id, ExpenseCategory category);
		...
		Task<ResponseCode> RemoveExpenseCategoryAsync(int id);
	}
}
